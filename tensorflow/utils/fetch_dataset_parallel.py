...
def get_image_urls(json_object: str):
	...
	image_urls = []
	for sess in json_object:
		json_temp = json_object[sess]
...
def main():
	...
	ap.add_argument("--session", required=True, help="SessionID to retrieve data."  )
	args = ap.parse_args()

	datetime = get_datetime()
	url = "https://io.xlabhq.com/projects/linkshaft/samples/from/?sessionId=" + args.session
